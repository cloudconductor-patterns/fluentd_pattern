...
describe CloudConductorPattern::EventHandler do
  ...
  describe '#initialize' do
    it 'creates and returns new instance' do
      ...
      expect(event_handler.instance_variable_get('@pattern_name')).to eq('fluentd_pattern')
  ...
  describe '#create_chefsolo_config_file' do
    it 'creates config file' do
      ...
      allow(dummy_file).to receive(:write).with("log_location '#{pattern_path}/logs/fluentd_pattern_web_chef-solo.log'\n")
